...
$GLOBALS['TL_LANG']['tl_content']['caroufredsel_image_legend'] = 'image settings';
$GLOBALS['TL_LANG']['tl_content']['caroufredsel_thumbnails_legend'] = 'carouFredSel thumbnails';
...
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsVisibleSelect'][0] = 'number of shown thumbnails';
...
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsPosition'][0] = 'position of thumbnails';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsPosition'][1] = 'Hier können Sie die Position der Vorschaubilder festlegen.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsAlign'][0] = 'alignment of thumbnails';
...
$GLOBALS['TL_LANG']['tl_content']['dk_cfsCssTpl'][1] = 'Choose the CSS template.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsJsTpl'][0] = 'JavaScript template';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsJsTpl'][1] = 'Choose the JavaScript template.';


/**
 * References
 */
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsVisibleSelect']['variable'][0] = 'variable';
 ...
 * Wizards
 */
$GLOBALS['TL_LANG']['tl_content']['dk_cfsEdit'][0] = 'Edit carousel configuration';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsEdit'][1] = 'Edit carousel configuration ID %s';

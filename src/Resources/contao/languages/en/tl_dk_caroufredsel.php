 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['new'][0] = 'New carousel';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['new'][1] = 'Create a new carousel';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['edit'][0] = 'Edit carousel';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['edit'][1] = 'Edit carousel ID %s';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['editheader'][0] = 'Edit carousel settings';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['editheader'][1] = 'Edit the settings of carousel ID %s';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['copy'][0] = 'Duplicate carousel';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['copy'][1] = 'Duplicate carousel ID %s';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['delete'][0] = 'Delete carousel';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['delete'][1] = 'Delete carousel ID %s';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['show'][0] = 'Details of carousel';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['show'][1] = 'Show the details of carousel ID %s';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsGeneral_legend'] = 'Displaying of items';
 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['title'][0] = 'Name of carousel';
...
// --- play behaviour
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['usePlay'][0] = 'Play behaviour';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['direction'][0] = 'Direction';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['direction'][1] = 'Scroll direction of the carousel.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['carouselType'][0] = 'Type';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['carouselType'][1] = 'Die Art wie die Elemente abgespielt werden.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollItems'][0] = 'Items';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollItems'][1] = 'The number of items to scroll. If 0, the number of visible items is used.';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['autoPlay'][0] = 'auto play';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['autoPlay'][1] = 'Determines whether the carousel should scroll automatically or not.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['autoTimeoutDuration'][0]	= 'Duration';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['autoTimeoutDuration'][1]	= 'The amount of milliseconds the carousel will pause between scrolling.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['autoDelay'][0] = 'Delay';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['autoDelay'][1] = 'Additional delay in milliseconds before the carousel starts scrolling the first time. This can also be a negative number.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollPauseOnHover'][0] = 'Pause on hover';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollPauseOnHover'][1] = 'Determines whether the timeout between transitions should be paused on mouse hover and how the transition will be handled afterwards.';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollFx'][0] = 'Transition';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollFx'][1] = 'Indicates which effect to use for the transition.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollEasing'][0] = 'Easing';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollEasing'][1] = 'Indicates which easing function to use for the transition.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollDuration'][0] = 'Duration';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollDuration'][1] = 'Determines the duration of the transition in milliseconds. If less than 10, the number is interpreted as a speed (pixel/millisecond).';

// --- general size
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['useGeneralSize'][0] = 'Size of carousel';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['widthSelect'][0] = 'Type of width';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['width'][0] = 'Width of carousel';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['width'][1] = 'Bestimmt die Breite des Karussells in Abhängigkeit der gewählten Art.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['heightSelect'][0] = 'Type of height';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['height'][0] = 'Height of carousel';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['align'][0] = 'Alignment';
...
// --- items size
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['useItemsSize'][0] = 'Size of items';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsWidthSelect'][0] = 'Type of width';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsWidth'][0] = 'Width of items';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsWidth'][1] = 'Bestimmt die Breite der Elemente in Abhängigkeit der gewählten Art.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsHeightSelect'][0] = 'Type of height';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsHeight'][0] = 'Hight of items';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['cookie'][0] = 'Saved position';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['cookie'][1] = 'Determines whether the carousel should start at its last viewed position.';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsVisible'][0] = 'number of visible items';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsVisible'][1] = 'The number of visible items.';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsStart'][0] = 'Number of start element';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsStart'][1] = 'The nth item to start the carousel. If 0, the first one will be used. This can also be a negative number.';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['prevKey'][0] = 'Key to scroll backward';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['prevKey'][1] = 'Bestimmt mit welcher Taste zurück gescrollt werden kann.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['nextKey'][0] = 'Key to scroll forward';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['nextKey'][1] = 'Bestimmt mit welcher Taste vorwärts gescrollt werden kann.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['mousewheel'][0] = 'Scrolling by mousewheel';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['mousewheel'][1] = 'Determines wether the carousel is scrolled by mousewheel.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['swipeOnTouch'][0] = 'Scrolling by wipe action';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['swipeOnTouch'][1] = 'Determines wether the carousel is scrolled by wipe action.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['swipeOnMouse'][0] = 'Scrolling by mouse dragging';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['swipeOnMouse'][1] = 'Determines wether the carousel is scrolled by mouse dragging.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['navigation'][0] = 'show navigation';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['pagination'][0] = 'show pagination';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['pagination'][1] = 'Bestimmt, ob eine visuelle Pagination eingeblendet werden soll.';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['paginationKeys'][0] = 'pagination can be controlled via keys 1-9';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['circular'][0] = 'circular';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollQueue']['all'][0] = 'all';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollQueue']['first'][0] = 'first';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollQueue']['last'][0] = 'last';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollPauseOnHover']['none'][0] = 'none';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['align']['center'] = 'center';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['align']['left'] = 'left/top';
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['align']['right'] = 'right/bottom';

$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsVisibleSelect']['variable'][0] = 'variable';
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsVisibleSelect']['fixed'][0] = 'fixed';
 ...
 */
$GLOBALS['TL_LANG']['DK_CFS']['widthSelect']['variable'][0] = 'variable';
...
$GLOBALS['TL_LANG']['DK_CFS']['widthSelect']['auto'][0] = 'auto';
...
$GLOBALS['TL_LANG']['DK_CFS']['widthSelect']['fixed'][0] = 'fixed';
...
$GLOBALS['TL_LANG']['DK_CFS']['widthSelect']['fluid'][0] = 'fluid';
...
$GLOBALS['TL_LANG']['DK_CFS']['heightSelect']['variable'][0] = 'variable';
...
$GLOBALS['TL_LANG']['DK_CFS']['heightSelect']['auto'][0] = 'auto';
...
$GLOBALS['TL_LANG']['DK_CFS']['heightSelect']['fixed'][0] = 'fixed';
...
$GLOBALS['TL_LANG']['DK_CFS']['heightSelect']['fluid'][0] = 'fluid';
 ...
 * Messages
 */
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['basicModeInfo'] = 'The extension is configured to show the most common settings only. To use all settings please enable the advanced mode in the Contao settings.';

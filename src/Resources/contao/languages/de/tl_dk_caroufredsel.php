 ...
 * Hinweise
 */
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['basicModeInfo'] = 'Die Erweiterung ist so konfiguriert, dass die am häufigsten verwendeten Einstellungen zur Verfügung stehen. Um alle Einstellungen zu nutzen, können Sie in den Contao-Einstellungen den erweiterten Modus aktivieren.';

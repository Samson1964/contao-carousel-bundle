...
$GLOBALS['TL_LANG']['tl_content']['caroufredsel_image_legend'] = 'Bild-Einstellungen';
...
$GLOBALS['TL_LANG']['tl_content']['dk_cfsUseThumbnails'][0] = 'Vorschaubilder einblenden';
...
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsVisibleSelect'][0] = 'Anzahl der Vorschaubilder';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsVisibleSelect'][1] = 'Bestimmt die Art wie die Anzahl der sichtbaren Vorschaubilder ermittelt wird.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsVisible'][0] = 'gleichzeitig sichtbare Vorschaubilder';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsVisible'][1] = 'Anzahl der gleichzeitig sichtbaren Vorschaubilder.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailSize'][0] = 'Vorschaubildbreite und -höhe';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailSize'][1] = 'Hier können Sie die Abmessungen der Vorschaubilder und den Skalierungsmodus festlegen.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsPosition'][0] = 'Position der Vorschaubilder';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsPosition'][1] = 'Hier können Sie die Position der Vorschaubilder festlegen.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsAlign'][0] = 'Ausrichtung der Vorschaubilder';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsAlign'][1] = 'Bestimmt die Ausrichtung der Vorschaubilder innerhalb ihres Karussells.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsWidth'][0] = 'Vorschaubild-Karussell-Breite';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsWidth'][1] = 'Bestimmt die Breite des Vorschaubilder-Karussells in Abhängigkeit der gewählten Art. Lassen Sie das Feld leer wird bei Position oben/unten die Karussell-Breite verwendet.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsHeight'][0] = 'Vorschaubild-Karussell-Höhe';
...
$GLOBALS['TL_LANG']['tl_content']['dk_cfsCarouFredSel'][0] = 'carouFredSel-Konfiguration';
...
$GLOBALS['TL_LANG']['tl_content']['dk_cfsHtmlTpl'][1] = 'Hier können Sie das HTML-Template auswählen.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsCssTpl'][0] = 'CSS-Template';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsCssTpl'][1] = 'Hier können Sie das CSS-Template auswählen.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsJsTpl'][0] = 'JavaScript-Template';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsJsTpl'][1] = 'Hier können Sie das JavaScript-Template auswählen.';


/**
 * References
 */
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsVisibleSelect']['variable'][0] = 'variabel';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsVisibleSelect']['variable'][1] = 'Die Anzahl der sichtbaren Vorschaubilder richtet sich nach der vorgegebenen Größe und des zur Verfügung stehenden Platzes.';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsThumbnailsVisibleSelect']['fixed'][0] = 'fest';
 ...
 * Assistenten
 */
$GLOBALS['TL_LANG']['tl_content']['dk_cfsEdit'][0] = 'Karussell-Konfiguration bearbeiten';
$GLOBALS['TL_LANG']['tl_content']['dk_cfsEdit'][1] = 'Karussell-Konfiguration ID %s bearbeiten';
